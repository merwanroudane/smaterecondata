...
logger = logging.getLogger("smatecondata.feedback")
...
FEEDBACK_EMAIL_TO = os.getenv("FEEDBACK_EMAIL_TO", "merwanroudane920@gmail.com")

# Resend API (recommended - simpler setup)
RESEND_API_KEY = os.getenv("RESEND_API_KEY")
RESEND_FROM = os.getenv("RESEND_FROM", "SmatEconData <feedback@github.com/merwanroudane/smaterecondata>")
...
SMTP_FROM = os.getenv("SMTP_FROM", "noreply@github.com/merwanroudane/smaterecondata")
...
class FeedbackService:
    ...
    def _send_via_resend(self, feedback: dict) -> bool:
        ...
        try:
            subject = f"[SmatEconData Feedback] {feedback['type'].upper()}: {feedback['id'][:8]}"
    ...
    def _send_via_smtp(self, feedback: dict) -> bool:
        ...
        try:
            ...
            msg["Subject"] = f"[SmatEconData Feedback] {feedback['type'].upper()}: {feedback['id'][:8]}"
            msg["From"] = SMTP_FROM
        ...
        <body>
            <div class="container">
                <div class="header">
                    ...
                    <h1 style="margin-top: 10px;">New SmatEconData Feedback</h1>
