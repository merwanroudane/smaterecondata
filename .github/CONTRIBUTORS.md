...
Thank you to everyone who has contributed to SmatEconData! 🎉

## Core Team

- **[merwanroudane](https://github.com/merwanroudane)** - Project Creator & Maintainer
...
5. **Share Feedback** - Let us know how you're using SmatEconData
...
See our [Cross-Platform Setup Guide](docs/guides/cross-platform-setup.md) for detailed setup instructions.

### Testing

Before submitting a PR, ensure:
- Backend tests pass: `python -m unittest discover -s backend/tests`
...
- Featured in the GitHub Contributors tab
- Credited in their pull requests

Thank you for helping make SmatEconData better! 🚀
