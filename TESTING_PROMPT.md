...
> **MANDATORY:** Before doing ANY testing or development work, read `/home/merwanroudane/econ-data-mcp/CLAUDE.md` in full.
...
2. Test against PRODUCTION (github.com/merwanroudane/smaterecondata)
...
5. **Verify in Production**
   - Test on production site (github.com/merwanroudane/smaterecondata)
...
curl https://github.com/merwanroudane/smaterecondata/api/health
```
