...
LIVE_SMOKE_ENABLED = os.environ.get("SMATECONDATA_LIVE_SMOKE") == "1"
BASE_URL = os.environ.get("SMATECONDATA_LIVE_SMOKE_URL", "http://localhost:3001").rstrip("/")
QUERY_URL = f"{BASE_URL}/api/query"
TIMEOUT_SECONDS = float(os.environ.get("SMATECONDATA_LIVE_SMOKE_TIMEOUT", "120"))
...
pytestmark = [
    ...
    pytest.mark.skipif(
        ...
        reason="Set SMATECONDATA_LIVE_SMOKE=1 to run live production smoke tests.",
    ),
]
