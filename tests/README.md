...
Integration test suites for the SmatEconData project.
...
SMATECONDATA_LIVE_SMOKE=1 backend/.venv/bin/pytest tests/test_live_chat_smoke.py -q
...
- Some scripts support testing production (https://github.com/merwanroudane/smaterecondata)
