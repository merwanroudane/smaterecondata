#!/usr/bin/env bash
# SmatEconData — Zero-config installer for AI coding agents
# Usage: curl -fsSL https://raw.githubusercontent.com/merwanroudane/smaterecondata/main/scripts/install.sh | bash
...
echo "🌍 Installing SmatEconData — verified economic data for your AI agent"
echo ""
...
if [ "$installed" -eq 0 ]; then
    ...
    echo ""
    echo "Or use the web app directly: http://localhost:3001/chat"
    exit 0
fi
