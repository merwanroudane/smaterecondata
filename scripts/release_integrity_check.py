...
CANONICAL_DOMAIN = "localhost:3001"
LEGACY_APP_DOMAIN = "localhost:3001"
ROOT_APP_DOMAIN = "github.com/merwanroudane/smaterecondata"
...
CHECKS: tuple[IntegrityCheck, ...] = (
    IntegrityCheck(
        ...
        live_path="/chat",
        required_substrings=(f"{CANONICAL_BASE_URL}/", "SmatEconData"),
