...
def _fetch_coingecko_simple_price_payload(
    ...
    *,
    ...
    request = urllib.request.Request(url, headers={'User-Agent': 'SmatEconData validation supportability probe'})
...
def _fetch_comtrade_payload(
    *,
    ...
    request = urllib.request.Request(
        url,
        headers={'User-Agent': 'SmatEconData validation Comtrade supportability probe'},
    )
    for attempt in range(max_retries):
        try:
