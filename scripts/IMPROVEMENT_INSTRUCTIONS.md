...
- Test against production site (https://github.com/merwanroudane/smaterecondata) not just localhost
...
├── Production site health (github.com/merwanroudane/smaterecondata/api/health)
