...
BASE_URL = os.environ.get("SMATECONDATA_MULTIROUND_BASE_URL", "http://localhost:3001").rstrip("/")
TIMEOUT = 90
DEFAULT_REPORT_PATH = os.environ.get("SMATECONDATA_MULTIROUND_REPORT")
DEFAULT_SUITE = os.environ.get("SMATECONDATA_MULTIROUND_SUITE", DEFAULT_SUITE_NAME)
MIN_EFFECTIVE_RATE = float(os.environ.get("SMATECONDATA_MULTIROUND_MIN_EFFECTIVE_RATE", "0.90"))
MAX_FAILS = int(os.environ.get("SMATECONDATA_MULTIROUND_MAX_FAILS", "0"))
REQUEST_TIMEOUT = int(os.environ.get("SMATECONDATA_MULTIROUND_REQUEST_TIMEOUT", str(TIMEOUT)))
MAX_RETRIES = int(os.environ.get("SMATECONDATA_MULTIROUND_MAX_RETRIES", "2"))
RETRY_DELAY_SECONDS = float(os.environ.get("SMATECONDATA_MULTIROUND_RETRY_DELAY_SECONDS", "3"))
CONNECTION_RETRY_DELAY_SECONDS = float(os.environ.get("SMATECONDATA_MULTIROUND_CONNECTION_RETRY_DELAY_SECONDS", "5"))
ROUND_DELAY_SECONDS = float(os.environ.get("SMATECONDATA_MULTIROUND_ROUND_DELAY_SECONDS", "2"))
BETWEEN_TEST_DELAY_SECONDS = float(os.environ.get("SMATECONDATA_MULTIROUND_BETWEEN_TEST_DELAY_SECONDS", "3"))
HEALTH_RETRIES = int(os.environ.get("SMATECONDATA_MULTIROUND_HEALTH_RETRIES", "3"))
HEALTH_RETRY_DELAY_SECONDS = float(os.environ.get("SMATECONDATA_MULTIROUND_HEALTH_RETRY_DELAY_SECONDS", "5"))
