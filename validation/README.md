...
This directory defines the **claim-grade validation framework** for SmatEconData.

The goal is to support a defensible claim such as:

> On a frozen catalog snapshot, SmatEconData achieved at least 99% weighted
...
4. **Production holdout replay**
   - replay against `http://localhost:3001`
