    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <header className="bg-white border-b">
        <div className="max-w-6xl mx-auto px-4 py-4 flex items-center justify-between">
          <Link to="/" className="text-xl font-bold text-blue-600">SmatEconData</Link>
      ...
      <section className="bg-gradient-to-b from-blue-50 to-white py-12">
        <div className="max-w-6xl mx-auto px-4 text-center">
          ...
          >
            Live app: localhost:3001/chat
          </a>
          <a
            href={LIVE_DATA_APP_URL}
            className="inline-flex items-center gap-2 bg-blue-600 text-white px-6 py-3 rounded-lg font-medium hover:bg-blue-700 transition-colors"
          >
            Try SmatEconData Free
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <div className="text-sm">
              © {new Date().getFullYear()} SmatEconData. Query economic data with AI.
            </div>
            <nav className="flex flex-wrap items-center justify-center gap-4 md:gap-6 text-sm">
              ...
              <a href="mailto:merwanroudane920@gmail.com" className="hover:text-white">Contact</a>
            </nav>
          </div>
        </div>
      </footer>
