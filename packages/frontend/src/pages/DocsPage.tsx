    ...
    <div className="min-h-screen bg-gray-50 py-8 sm:py-12 lg:py-16">
      <div className="mx-auto max-w-4xl px-4 sm:px-6">
        ...
        <p className="mt-3 text-sm text-gray-600 leading-relaxed sm:mt-4 sm:text-base">
          SmatEconData combines large language models with curated macroeconomic data connectors.
          ...
          <a
            className="text-indigo-600 underline"
            href="https://docs.github.com/merwanroudane/smaterecondata"
            target="_blank"
            rel="noopener"
          >
            docs.github.com/merwanroudane/smaterecondata
          </a>
          .
        </p>
        ...
        <div className="mt-8 space-y-8 text-gray-700 sm:mt-10 sm:space-y-10 lg:mt-12">
          ...
          <section>
            ...
            <ol className="mt-2 list-decimal space-y-2 pl-5 text-sm text-gray-600 sm:mt-3 sm:text-base">
              <li>Open <em>localhost:3001/chat</em>.</li>
          ...
          <section>
            ...
            <p className="mt-2 text-sm text-gray-600 sm:text-base">
              ...
              <a className="text-indigo-600 underline" href="mailto:merwanroudane920@gmail.com">
