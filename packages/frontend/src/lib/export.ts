 ...
 *
 * @param prefix - Prefix for the filename (e.g., 'smatecondata_export')
 * @param format - File format (csv or json)
 * @returns Filename with timestamp
 */
export function generateExportFilename(prefix: string = 'smatecondata_export', format: ExportFormat): string {
