...
const LIVE_DATA_APP_URL = 'http://localhost:3001/chat'
...
const tools = [
  ...
  },
  {
    ...
    href: 'https://github.com/merwanroudane/econ-writing-skill',
    tag: 'Open source',
  ...
  },
  {
    ...
    href: 'https://github.com/merwanroudane/awesome-ai-for-economists',
    tag: 'Resource list',
      ...
      <header className="sticky top-0 z-50 border-b bg-white/80 backdrop-blur supports-[backdrop-filter]:bg-white/60">
        <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-5">
          <a href="#" className="flex items-center gap-2 text-lg sm:text-xl font-semibold">
            ...
            <span className="hidden xs:inline">SmatEconData</span>
            <span className="inline xs:hidden">SmatEconData</span>
          </a>
      ...
      >
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-5">
          <motion.div variants={fadeInUp}>
            <h2 className="text-xl font-semibold sm:text-2xl lg:text-3xl">SmatEconData tools</h2>
      ...
      <footer className="border-t py-6 sm:py-8 lg:py-10">
        <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-3 px-4 text-xs text-gray-600 sm:flex-row sm:gap-4 sm:text-sm lg:px-5">
          <div className="flex items-center gap-2">
            ...
            <span>SmatEconData © {new Date().getFullYear()}</span>
          </div>
          <div className="flex items-center gap-3 sm:gap-4">
            ...
            <a href="https://github.com/merwanroudane/smaterecondata" target="_blank" rel="noopener" className="hover:text-gray-900">
              GitHub
            </a>
            <a href="https://github.com/merwanroudane/smaterecondata/" target="_blank" rel="noopener" className="hover:text-gray-900">
              More tools ↗
            </a>
            <a href="mailto:merwanroudane920@gmail.com" className="hover:text-gray-900">
              Contact
            </a>
          </div>
        </div>
