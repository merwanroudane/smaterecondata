...
SmatEconData resolves natural language queries to specific economic indicators from a database of **330,000+ indicators** across 10 data providers. This document describes the resolution architecture and the decisions behind it.
