...
1. [CLAUDE.md](/opt/smatecondata/CLAUDE.md)
2. [TESTING_PROMPT.md](/opt/smatecondata/TESTING_PROMPT.md)
3. [/home/merwanroudane/.claude/projects/-home-merwanroudane-SmatEconData/memory/MEMORY.md](/home/merwanroudane/.claude/projects/-home-merwanroudane-SmatEconData/memory/MEMORY.md)
4. [docs/design/SEMANTIC_RUNTIME_BOUNDARY.md](/opt/smatecondata/docs/design/SEMANTIC_RUNTIME_BOUNDARY.md)
5. [docs/design/QUERY_OUTCOME_GUARANTEE_SYSTEM.md](/opt/smatecondata/docs/design/QUERY_OUTCOME_GUARANTEE_SYSTEM.md)
6. [docs/design/QUERY_OUTCOME_IMPLEMENTATION_ROADMAP.md](/opt/smatecondata/docs/design/QUERY_OUTCOME_IMPLEMENTATION_ROADMAP.md)
7. [/opt/smatecondata.omx-team-launch-20260412T022105Z/.omx/plans/plan-session-restart-2026-04-11-outcome-guarantee-consensus.md](/opt/smatecondata.omx-team-launch-20260412T022105Z/.omx/plans/plan-session-restart-2026-04-11-outcome-guarantee-consensus.md)
8. [/opt/smatecondata.omx-team-launch-20260412T022105Z/.omx/plans/prd-session-restart-2026-04-11-outcome-guarantee.md](/opt/smatecondata.omx-team-launch-20260412T022105Z/.omx/plans/prd-session-restart-2026-04-11-outcome-guarantee.md)
9. [/opt/smatecondata.omx-team-launch-20260412T022105Z/.omx/plans/test-spec-session-restart-2026-04-11-outcome-guarantee.md](/opt/smatecondata.omx-team-launch-20260412T022105Z/.omx/plans/test-spec-session-restart-2026-04-11-outcome-guarantee.md)
10. [docs/KEY_PROBLEMS.md](/opt/smatecondata/docs/KEY_PROBLEMS.md)
...
- [backend/services/semantic_match_judge.py](/opt/smatecondata/backend/services/semantic_match_judge.py)
  New model-backed semantic judgment module.

- [backend/services/provider_fallback.py](/opt/smatecondata/backend/services/provider_fallback.py)
  Fallback relevance is now structural-only. Semantic acceptance moved out of this module.

- [backend/services/query.py](/opt/smatecondata/backend/services/query.py)
  Added runtime wrappers for model-backed semantic judging, including async direct translation verification.

- [backend/services/indicator_clarification.py](/opt/smatecondata/backend/services/indicator_clarification.py)
...
- [backend/services/indicator_resolution.py](/opt/smatecondata/backend/services/indicator_resolution.py)
...
- [backend/tests/test_query_service.py](/opt/smatecondata/backend/tests/test_query_service.py)
...
- [docs/design/SEMANTIC_RUNTIME_BOUNDARY.md](/opt/smatecondata/docs/design/SEMANTIC_RUNTIME_BOUNDARY.md)
  Active runtime rule: no semantic rule patches in runtime logic.

- [docs/design/QUERY_OUTCOME_GUARANTEE_SYSTEM.md](/opt/smatecondata/docs/design/QUERY_OUTCOME_GUARANTEE_SYSTEM.md)
  Explains the current workflow structure, where drift happens, and the intended outcome-guarantee architecture.

- [docs/design/QUERY_OUTCOME_IMPLEMENTATION_ROADMAP.md](/opt/smatecondata/docs/design/QUERY_OUTCOME_IMPLEMENTATION_ROADMAP.md)
...
1. [backend/services/indicator_resolution.py](/opt/smatecondata/backend/services/indicator_resolution.py)
   Remaining issues:
...
2. [backend/services/indicator_clarification.py](/opt/smatecondata/backend/services/indicator_clarification.py)
   Remaining issues:
...
3. [backend/services/relevance_scorer.py](/opt/smatecondata/backend/services/relevance_scorer.py)
   Remaining issues:
