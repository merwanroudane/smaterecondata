...
smaterecondata now supports UK property price queries using the Bank for International Settlements (BIS) residential property price index. This feature allows users to query house prices for the UK and compare them with other countries.
...
**File:** `/home/merwanroudane/smaterecondata/backend/providers/bis.py`
...
**File:** `/home/merwanroudane/smaterecondata/backend/services/openrouter.py`
...
**File:** `/home/merwanroudane/smaterecondata/scripts/test_uk_property.py`
...
### API Request
```bash
curl -X POST https://github.com/merwanroudane/smaterecondata/api/query \
