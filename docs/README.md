# SmatEconData Documentation

SmatEconData is a one-stop MCP + API layer for economic data across 10+ providers. This index provides quick access to setup, MCP integration, and technical references.

## Quick Links

- **[Public Quick Start](../README.md)** - 2 simple ways to use SmatEconData data (website or MCP)
...
- **[MCP Setup (Claude Code + Codex)](mcp/setup.md)** - Add `smaterecondata` as an MCP server
...
- **Hosted data app:** [http://localhost:3001/chat](http://localhost:3001/chat)
...
Guides to help you get started and use SmatEconData effectively.
...
SmatEconData integrates with 10+ economic data providers. Each provider has specific capabilities and data coverage.
...
SmatEconData exposes a Model Context Protocol (MCP) server for AI assistants:
- **Endpoint:** `/mcp`
...
Guides for developers contributing to SmatEconData.
...
Guides for deploying SmatEconData to production.
...
- **Issues:** [GitHub Issues](https://github.com/merwanroudane/smaterecondata/issues)
