...
```
/home/merwanroudane/smaterecondata/
...
PROMODE_PUBLIC_DIR=/home/merwanroudane/smaterecondata/public_media/promode
...
Add this to your Apache virtual host configuration (e.g., `/etc/apache2/sites-available/github.com/merwanroudane/smaterecondata-le-ssl.conf`):

```apache
<VirtualHost *:443>
    ServerName github.com/merwanroudane/smaterecondata

    # Serve built frontend
    DocumentRoot /home/merwanroudane/smaterecondata/packages/frontend/dist

    # Serve Pro Mode generated files at /static/promode/
    Alias /static/promode /home/merwanroudane/smaterecondata/public_media/promode
    <Directory /home/merwanroudane/smaterecondata/public_media/promode>
        Require all granted
    ...
    <Directory /home/merwanroudane/smaterecondata/packages/frontend/dist>
        Require all granted
        Options -Indexes +FollowSymLinks
        AllowOverride None
    ...
    SSLEngine on
    SSLCertificateFile /etc/letsencrypt/live/github.com/merwanroudane/smaterecondata/fullchain.pem
    SSLCertificateKeyFile /etc/letsencrypt/live/github.com/merwanroudane/smaterecondata/privkey.pem
</VirtualHost>
```
...
```bash
mkdir -p /home/merwanroudane/smaterecondata/public_media/promode
chmod 755 /home/merwanroudane/smaterecondata/public_media
chmod 755 /home/merwanroudane/smaterecondata/public_media/promode
```
...
Create a test file:
```bash
echo "Test file" > /home/merwanroudane/smaterecondata/public_media/promode/test.txt
```

Access it in browser:
```
https://github.com/merwanroudane/smaterecondata/static/promode/test.txt
```
...
```bash
# Check Apache config
sudo apache2ctl -S | grep smatecondata

# Verify Alias directive exists
sudo grep -n "Alias /static/promode" /etc/apache2/sites-available/github.com/merwanroudane/smaterecondata-le-ssl.conf
...
chmod 755 /home/merwanroudane/smaterecondata/public_media
chmod 755 /home/merwanroudane/smaterecondata/public_media/promode
chmod 644 /home/merwanroudane/smaterecondata/public_media/promode/*.png
chmod 644 /home/merwanroudane/smaterecondata/public_media/promode/*.csv

# Check Apache error log
sudo tail -50 /var/log/apache2/smatecondata-error.log
```
...
cd /home/merwanroudane/smaterecondata
...
```bash
# Remove old files
find /home/merwanroudane/smaterecondata/public_media/promode -type f -mtime +1 -delete
    ...
    <rewrite>
      <rules>
        <rule name="Pro Mode Static Files">
          ...
          <action type="Rewrite" url="C:\smaterecondata\public_media\promode\{R:1}" />
        </rule>
      </rules>
    </rewrite>
  </system.webServer>
...
server {
    listen 443 ssl;
    server_name github.com/merwanroudane/smaterecondata;

    # Serve frontend
    root /home/merwanroudane/smaterecondata/packages/frontend/dist;

    # Serve Pro Mode files
    location /static/promode/ {
        alias /home/merwanroudane/smaterecondata/public_media/promode/;
