...
PYTHONPATH=/home/merwanroudane/smaterecondata python3 tests/test_imf_regional_queries.py

# Test failing queries
PYTHONPATH=/home/merwanroudane/smaterecondata python3 tests/test_imf_failing_queries.py

# View summary
PYTHONPATH=/home/merwanroudane/smaterecondata python3 tests/test_imf_regional_fix_summary.py
```
