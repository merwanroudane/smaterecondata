# smaterecondata Routing System Consolidation Analysis
...
The smaterecondata backend currently has **3+ overlapping routing systems** that make provider selection decisions. This analysis evaluates the benefits and risks of consolidating these systems, followed by a detailed 100-step implementation plan.
