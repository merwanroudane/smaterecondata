...
smaterecondata now supports **flexible LLM backends**, allowing you to switch between OpenRouter, local models (Ollama, LM Studio), and other LLM providers without changing code.
...
The LLM abstraction makes smaterecondata:
